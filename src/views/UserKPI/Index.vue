      ...
      <div class="box " id="box" style="display:none">
        ...
        <div class="box-body">
          <div class="text-center periodAll" style="display:none">
            <a class="btn bg-primary btn-sm weeklyperiod" data-period="W"><i class="fa fa-eye"></i>&#160;View all by weekly</a>
            <a class="btn bg-primary btn-sm monthlyperiod" data-period="m"><i class="fa fa-eye"></i>&#160;View all by monthly</a>
            <a class="btn bg-primary btn-sm quarterlyperiod" data-period="q"><i class="fa fa-eye"></i>&#160;View all by quarterly</a>
            <a class="btn bg-primary btn-sm yearlyperiod" data-period="y"><i class="fa fa-eye"></i>&#160;View all by yearly</a>
                  ...
                  <div class="tooltip-css ">
                    <div class="pretty p-icon p-rotate ">
                      ...
                      <div class="state p-success textOverflow">
                          <div class="black labelOverflow">{{item.KPIName}}</div>
                      </div>
                    </div>
